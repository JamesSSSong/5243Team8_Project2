        ...
        sidebarPanel(
          tabsetPanel(
            ...
            tabPanel("Making New Feature",
                     ...
                     selectizeInput("opF", "Operation Choice", choices = c("Addition","Subtraction","Multiplication","Division","Natural Log","Power", "Month", "Year", "Day of the Week", "Differencing", "Rolling Mean")),
                     selectizeInput("timeVars2", "Time Variable of Reference", choices = NULL),
